  ...
  return (
    <>
      ...
      <main className="grid grid-cols-4 gap-4">
        <h2 className="before:top-10 before:ms-7 before:w-20 before:h-1 text-center relative font-bold text-3xl my-5 before:absolute before:bg-gray-300 ">Category</h2>
