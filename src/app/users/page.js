...
export default function Users(){
    ...
    const validateSchema = Yup.object().shape({
        ...
        title: Yup.string().min(2,"Invalid title"),
    ...
    const insertUser = async (data) => {
        let {name, title, description, role, avatar} = data
                                    ...
                                    <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <Field type="title" name="title" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="title" required="" />
                                                <ErrorMessage 
                                                    name="title"
                                                >
                                                    {msg => <div className="text-red-600">{msg}</div>}
